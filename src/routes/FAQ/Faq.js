        ...
        <>
            ...
            <div className="container  py-5">
                ...
                <div className='mx-2 mt-4'>
                    <div className='rounded-2 rounded shadow text-dark' style={{height: "70px", overflow: "hidden"}}>
                        <button className='bg-dark h-100 text-light fs-1 d-inline justify-content-center align-items-center' style={{width: "70px"}} data-bs-toggle="collapse" data-bs-target="#faq-1" role="button" aria-expanded="false">
                            <i className="bi bi-plus"></i>
                        </button>
                        <span className='ms-4'>How do I sign up to be a Vendor?</span>
                    </div>
                ...
                <div className='mx-2 mt-4'>
                    <div className='rounded-2 rounded shadow text-dark' style={{height: "70px", overflow: "hidden"}}>
                        ...
                        <span className='ms-4'> Do I need Physical store to be a Vendor?</span>
                    </div>
